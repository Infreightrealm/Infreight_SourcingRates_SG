...
const DEFAULT_BASE = "#020617";
const DEFAULT_MID = "#0c243c";
const DEFAULT_SHEEN = "#93c5fd";
...
export function SilkAurora({
  ...
  const fallbackContent = (
    <div
      className={cn(
        "relative flex min-h-screen w-full items-center overflow-hidden bg-[#020617] text-white",
        className,
      )}
        ...
        (title || subtitle || description || children) && (
          <div className="relative z-10 mx-auto w-full max-w-[1240px] px-6 py-20 md:px-10 md:py-28">
            <div className="max-w-[760px]">
              {subtitle && (
                <p className="mb-5 text-xs font-medium uppercase tracking-[0.24em] text-cyan-300/80">
                  {subtitle}
                </p>
              )}
  ...
  return (
    <WebGLErrorBoundary fallback={fallbackContent}>
      ...
      >
        ...
        />
        {/* Oceanic lighting scrims */}
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_65%_35%,rgba(56,189,248,0.12),transparent_35%),radial-gradient(circle_at_20%_75%,rgba(2,132,199,0.18),transparent_40%)]" />
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(90deg,rgba(2,6,23,0.55),rgba(2,6,23,0.2)_45%,rgba(2,6,23,0.5))]" />
