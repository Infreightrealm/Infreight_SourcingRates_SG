          ...
          <div className="grid grid-cols-2 gap-3 animate-fade-in-up stagger-1">
            {[
              ...
              ...(quote.port_of_discharge
                ? [
                    { label: "Port of Discharge", value: quote.port_of_discharge },
                    { label: "Routing", value: quote.routing || "Direct", fullWidth: true },
                  ]
                : [
                    { label: "Routing", value: quote.routing || "Direct" },
                  ]),
            ].map((item, i) => (
              <div
                key={i}
                className={`rounded-lg px-3 py-2 ${item.fullWidth ? "col-span-2" : ""} ${
                  item.label.includes("Free Time") && quote.free_time != null
