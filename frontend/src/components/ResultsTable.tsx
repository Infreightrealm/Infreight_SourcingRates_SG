            ...
            <table className="w-full text-xs relative">
              <thead className="sticky top-0 z-10">
                <tr className="border-b border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-[#1a1f2e] backdrop-blur-md">
                  <th className="px-2 py-3 text-left text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Carrier</th>
                  <th className="px-2 py-3 text-left text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Status</th>
                  <th className="px-2 py-3 text-left text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Container</th>
                  <th className="px-2 py-3 text-left text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">ETD POL</th>
                  <th className="px-2 py-3 text-left text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">ETA POD</th>
                  <th className="px-2 py-3 text-left text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Validity Till</th>

                  <th className="px-2 py-3 text-center text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Transit</th>
                  <th className="px-2 py-3 text-center text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Free Time</th>
                  <th className="px-2 py-3 text-left text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Service / Vessel</th>
                  <th className="px-2 py-3 text-right text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">BOF</th>
                  <th className="px-2 py-3 text-right text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Discount</th>
                  <th className="px-2 py-3 text-right text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Surcharges</th>
                  <th className="px-2 py-3 text-right text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Final Value</th>
                  <th className="px-2 py-3 text-center text-xs font-semibold text-slate-600 dark:text-white/60 uppercase tracking-wider whitespace-nowrap">Actions</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  <tr key={i} className="border-b border-slate-100 dark:border-white/5 hover:bg-slate-50 dark:hover:bg-white/[0.03] transition-all duration-200 hover:-translate-y-[1px] row-enter" style={{animationDelay: `${i * 0.04}s`}}>
                    ...
                    {row.quote ? (
                      <>
                        ...
                        <td className="px-2 py-3 text-slate-600 dark:text-white/70 font-mono text-xs whitespace-nowrap">{formatDate(row.quote.etd)}</td>
                        <td className="px-2 py-3 text-slate-600 dark:text-white/70 font-mono text-xs whitespace-nowrap">{formatDate(row.quote.eta)}</td>
                        <td className="px-2 py-3 text-slate-600 dark:text-white/70 font-mono text-xs whitespace-nowrap">{formatDate(row.quote.validity_till)}</td>
                        <td className="px-2 py-3 text-center text-slate-600 dark:text-white/70 whitespace-nowrap">{row.quote.transit_time_days ? `${row.quote.transit_time_days}d` : "—"}</td>
                        ...
                        <td className="px-2 py-3 text-right font-mono text-slate-700 dark:text-white/80">
                          {row.quote.final_freight_value === 0.0 ? "—" : row.quote.basic_ocean_freight.toLocaleString(undefined, { minimumFractionDigits: 2 })}
                        </td>
                        <td className="px-2 py-3 text-right font-mono text-red-600 dark:text-red-400">
                          {row.quote.discount !== 0 ? row.quote.discount.toLocaleString(undefined, { minimumFractionDigits: 2 }) : "—"}
                        </td>
                        <td className="px-2 py-3 text-right font-mono text-blue-600 dark:text-blue-300">
                      ...
                      <td colSpan={12} className="px-2 py-3 text-xs text-center">
