...
export const STATUS_MAP: Record<string, { label: string; color: string; bg: string }> = {
  ...
  MANUAL_ACTION_REQUIRED: { label: "Action Required", color: "text-amber-400", bg: "bg-amber-400/10" },
  WAITING_FOR_HUMAN_VERIFICATION: { label: "Solve CAPTCHA", color: "text-amber-400", bg: "bg-amber-400/10" },
  BOT_CHALLENGE_DETECTED: { label: "CAPTCHA Detected", color: "text-orange-400", bg: "bg-orange-400/10" },
